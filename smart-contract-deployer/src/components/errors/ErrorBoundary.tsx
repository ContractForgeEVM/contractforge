...
export class ErrorBoundary extends Component<Props, State> {
  ...
  private handleReportBug = async () => {
    ...
    try {
      ...
      // Ouvrir GitHub issues (optionnel)
...
// 🎯 Error Boundary pour les pages complètes
...
// 🎯 Hook pour déclencher des erreurs (utile pour testing)
...
// 🎯 Composant simple pour afficher des états d'erreur
