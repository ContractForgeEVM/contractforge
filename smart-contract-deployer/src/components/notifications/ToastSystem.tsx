...
// Couleurs personnalisées adaptées au thème sombre
...
// Fonction pour obtenir l'URL de l'explorateur
            ...
            >
              <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 2 }}>
                ...
                <Box sx={{ flex: 1, minWidth: 0 }}>
                  ...
                  {/* Lien vers l'explorateur si disponible */}
                  {explorerUrl && (
                    <Link
                      href={explorerUrl}
                      target="_blank"
...
// Export d'un objet toast global pour utilisation en dehors des composants React
...
// Hook pour initialiser la référence globale
